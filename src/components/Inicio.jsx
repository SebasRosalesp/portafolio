               ...
               <div className="tecno"><p className="tecnoText">Tecnologías que domino</p></div>
                <div className="technologies">
                    <div className="html tImg">
                        <div><img alt="html 5" src="src/components/assets/html-5.png"/>HTML5</div>
                    </div>
                    <div className="css tImg">
                        <div><img alt="css 3" src="src/components/assets/css-3.png"/>CSS3</div>
                    </div>
                    <div className="js tImg">
                        <div><img alt="JavaScript" src="src/components/assets/js.png"/>JavaScript</div>
                    </div>
                    <div className="react tImg">
                        <div><img alt="react" src="src/components/assets/React.png"/>React</div>
                    </div>
                    <div className="vite tImg">
                        <div><img alt="vite" src="/src/components/assets/vite-js-logo.svg"/>Vite</div>
                    </div>
